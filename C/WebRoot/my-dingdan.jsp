<%@page import="com.xh.servicelmpl.Forge_Users_TracksServiceImpl"%>
<%@page import="com.xh.service.Forge_Users_TracksService"%>
	...
	<div class="member-center clearfix">
		...
		<div class="member-right fr">
			...
			<%
				...
				Forge_Users_TracksService trackSer=new Forge_Users_TracksServiceImpl();
				tracks=trackSer.findAll(user.getId());
				for(Forge_Users_Tracks trsk:tracks){
					name=trsk.getProductName();
			%>
			<div class='digit1'>
			<a href="#">
			<img src="images/shangpinxiangqing/X-1.png" width="200px" height="200px"><br/>
			<a href="#">时间：<%=trsk.getViewTime() %></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			<br/>
			<a href="#">浏览商品:<%=name %></a>
			</a>
			</div>	
