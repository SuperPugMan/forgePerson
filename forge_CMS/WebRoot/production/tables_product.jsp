                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <table id="datatable" class="table table-striped table-bordered">
                      ...
                      <tbody>
                      <c:forEach items="${sessionScope.proList}" var="pros">
	                      <tr>
	                          <td >${pros.id }</td>
	                          <td >${pros.name }</td>
	                          ...
	                          <td >${pros.price }</td>
	                          <td >${pros.stock }</td>
	                          <td >${pros.categorylevel1 }</td>
	                          <td >${pros.categorylevel2 }</td>
	                          <td >${pros.categorylevel3 }</td>
	                          <td >${pros.fileName }</td>
	                          <td >${pros.score }</td>
	                          <td style="text-align: left; line-height: 0px">
	                          <a href="/forge_CMS/pro?method=findById&id=${pros.id }" class="btn btn-success" >修改商品</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	                          <a  type="button" class="btn btn-primary" href="javascript:del('/forge_CMS/pro?method=delete&id=${pros.id }')">删除商品</a></td>
	                        </tr>
                      </c:forEach>
                      </tbody>
                    </table>
