                    ...
                    <table id="datatable" class="table table-striped table-bordered">
                      ...
                      <c:forEach items="${sessionScope.newsList}" var="news">
	                      <tr>
	                          ...
	                          <a href="/forge_CMS/news?method=findById&id=${news.id}" class="btn btn-success" >修改新闻</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	                          <a  type="button" class="btn btn-primary" href="javascript:del('/forge_CMS/news?method=delete&id=${news.id}')">删除新闻</a></td>
	                        </tr>
                      </c:forEach>
                      </tbody>
                    </table>
