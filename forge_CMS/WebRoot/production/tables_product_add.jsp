								...
								<div class="x_panel">
									...
									<div class="x_content">
										...
										<form id="demo-form2" data-parsley-validate
											...
											action="/forge_CMS/pro?method=message" method="post"
											enctype="multipart/form-data">

											<div class="form-group">
												
												<label class="control-label col-md-3 col-sm-3 col-xs-12"
													for="price">请输入新增商品姓名 <span class="required">*</span>
												</label>
												...
												<label class="control-label col-md-3 col-sm-3 col-xs-12"
													for="price">请输入新增商品价格 <span class="required">*</span>
												</label>
												<div class="col-md-6 col-sm-6 col-xs-12">
													<input type="text" id="price" required="required"
												...
												<label class="control-label col-md-3 col-sm-3 col-xs-12"
													for="price">请输入新增商品库存 <span class="required">*</span>
												</label>
												<div class="col-md-6 col-sm-6 col-xs-12">
													<input type="text" id="price" required="required"
												...
												<label class="control-label col-md-3 col-sm-3 col-xs-12"
													for="price">请输入新增商品一级分类 <span class="required">*</span>
												</label>
												<div class="col-md-6 col-sm-6 col-xs-12">
													<input type="text" id="price" required="required"
												...
												<label class="control-label col-md-3 col-sm-3 col-xs-12"
													for="price">请输入新增商品二级分类 <span class="required">*</span>
												</label>
												<div class="col-md-6 col-sm-6 col-xs-12">
													<input type="text" id="price" required="required"
														class="form-control col-md-7 col-xs-12" name="level2">
												</div>
												<label class="control-label col-md-3 col-sm-3 col-xs-12"
													for="price">请输入新增商品三级分类 <span class="required">*</span>
												</label>
												<div class="col-md-6 col-sm-6 col-xs-12">
													<input type="text" id="price" required="required"
														class="form-control col-md-7 col-xs-12" name="level3">
												</div>
												<label class="control-label col-md-3 col-sm-3 col-xs-12"
													for="price">请输入新增商品积分 <span class="required">*</span>
												</label>
												<div class="col-md-6 col-sm-6 col-xs-12">
													<input type="text" id="price" required="required"
														class="form-control col-md-7 col-xs-12" name="score">
												</div>
												<br>
												...
												<!-- 富文本编辑器 -->
											<label class="control-label" for="textarea2"  id="newscontenttext">请输入新增商品内容 <span>*</span></label>
											...
											<!-- 文件上传开始 -->
											<div class="control-group">
												<label class="control-label" id="newsimagetext">请输入商品图片<span>*</span></label>
